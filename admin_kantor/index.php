...
<?php
	...
	if(!isset($_SESSION['nama'])){
		...
		exit();
	} else if($_SESSION['kode_jabatan']!='10'){
		echo "<script>
...
<div class="row">
  ...
  Selamat Datang <?php echo $_SESSION['nama'];?>, Silahkan Menggunakan Menu Disamping !! Untuk Memulai Pekerjaan Anda. </br>
  Pastika Anda LOGOUT Sebelum Meninggalkan Halaman Ini Demi Keamanan Data Anda.   
  </div>
</div>
