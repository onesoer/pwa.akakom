<?php
	...
	if ($simpan == "EDIT"){
		...
		$sql = "INSERT INTO `user` (`idUser`, `nama`, `kode_jabatan`, `password`, `foto`, `tanggal_lahir`,        `no_kontak`) VALUES ('$idUser', '$nama', '$kode_jabatan', MD5('$password'), '$foto', '$tanggal_lahir', '$no_kontak')";
	}	
